...
<html lang="ko">
	<head>
		...
		<meta name="keywords" content="메타버스,전시회,nft,klay,클레이,klaytn,클레이튼,coin,코인,ido,token,토큰,cryptocurrency,암호화폐"/>
	...
	<body>
		<div>
			<a href="${exhibitionPath}" style="text-decoration: none;">
...
<script>
	window.location.href = '${exhibitionPath}';
</script>
